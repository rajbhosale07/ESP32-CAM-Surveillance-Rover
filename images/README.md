This folder contains images for all the connection work i.e. pin diagram, implementation diagram, software implementation (Arduino IDE) 

# Implementation Images 

## Motor Control Testing
![Motor Test](motor_test.png)
